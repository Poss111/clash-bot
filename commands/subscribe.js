        ...
        try {
            ...
            if (!userDetails.subscriptions || !userDetails.subscriptions.UpcomingClashTournamentDiscordDM) {
                ...
                if (!userDetails.subscriptions || updatedUserDetails.subscriptions.UpcomingClashTournamentDiscordDM) {
                    await msg.reply('You have subscribed. You will receive a notification the Monday before a Clash Tournament weekend. If you want to unsubscribe at any time please use !clash unsubscribe');
                } else {
                    await msg.reply('Subscription failed. Please try again.');
                }
            } else {
